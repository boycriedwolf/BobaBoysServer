...
public class ServerConstants {
	...
	public static String REQUEST_STATUS_MESSAGE = "message";
	public static String NUM_FREE_PMT = "number_of_free_pearl_milk_tea";
	public static String SAVE_TO_DB_ERROR = "error_saving_to_database";
	public static String CLIENT_IS_NOT_ADMIN = "client_is_not_admin";
	public static String NUM_ACCEPTED = "number_of_users_accepted";
	public static String NUM_TEXTS_SENT = "number_of_texts_sent";
	public static String EMAIL_DOESNT_EXIST = "email_not_in_database";
	public static String INCORRECT_PASSWORD = "incorrect_password";
	public static String NO_AFFILIATION = "no_affiliation";
	public static String NO_DEFAULT_DELIVERY_ADDRESS = "no_default_delivery_address";
	public static String ORDERS_EXIST = "orders_exist";
	public static String EMAIL_EXISTS_IN_DB = "email_exists_in_database";
	...
	public static int STAMP_CARD_NUMBER = 10;
